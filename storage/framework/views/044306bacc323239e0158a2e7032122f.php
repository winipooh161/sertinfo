    ...
    <div class="container position-relative">
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <h5 class="mb-0 text-white fs-4 fw-bold"><?php echo e(config('app.name', 'Laravel')); ?></h5>
                </div>
        ...
        <div class="row py-3 align-items-center">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0 text-white-50 small">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Laravel')); ?>. Все права защищены.</p>
            </div>
...
</footer><?php /**PATH C:\OSPanel\domains\sertLendos\resources\views/layouts/footer.blade.php ENDPATH**/ ?>