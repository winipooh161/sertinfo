        ...
        <div class="row g-4 pricing-cards">
            ...
            <div class="col-lg-4">
                <div class="bg-transparent p-0 rounded-4 h-100 position-relative pricing-card">
                    ...
                    <div class="p-4 text-center mt-2">
                        <a href="{{ route('external.auth') }}" class="btn btn-outline-primary rounded-pill px-5 py-3 hover-lift">Выбрать план</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="bg-transparent p-0 rounded-4 h-100 position-relative pricing-card pricing-card-featured">
                    ...
                    <div class="p-4 text-center mt-2">
                        <a href="{{ route('external.auth') }}" class="btn btn-primary rounded-pill px-5 py-3 hover-lift">Выбрать план</a>
                    </div>
                </div>
            </div>
